package com.example.triznylarasati.newgson;
    ...
    public void process_json(String json_str) throws JSONException {
        try {
            ...
            for (int i = 0; i < users.length(); i++) {
                ...
                User model_user = gson_user.fromJson(String.valueOf(user), User.class); //fromjson digunakan utk mengubah dari json ke java
